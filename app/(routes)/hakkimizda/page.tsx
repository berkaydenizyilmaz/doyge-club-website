  ...
  return (
    <div className="flex flex-col p-8 mt-3 items-center gap-8 max-w-6xl mx-auto">
      ...
      <p className="text-xl text-center px-4 md:px-10 lg:px-20">
        ...
        yazılım geliştirme gibi geniş bir alanda çalışmalar yürüten bir öğrenci
        topluluğudur. Teknolojiye ilgi duyan öğrencilere yönelik atölye
        çalışmaları, eğitimler ve projeler düzenleyerek, üyelerimizin hem
        bireysel gelişimini hem de ekip çalışması yeteneklerini geliştirmeyi
        amaçlıyoruz. Amacımız, oyun ve yazılım geliştirme alanındaki yenilikçi
        fikirleri destekleyerek, sektörde fark yaratacak projeler üretmek ve
        öğrencilerin bu süreçte deneyim kazanmalarını sağlamaktır.
      </p>
      ...
      <div className="text-center px-4 md:px-10 lg:px-20">
        ...
        <p className="text-xl">
          ...
          teşvik eden, Amasya Üniversitesi’nde teknoloji meraklılarına rehberlik
          eden, yerel ve uluslararası düzeyde rekabetçi projeler üreten bir
          topluluk olmayı hedefliyoruz. Mobil uygulamalardan veritabanı
          sistemlerine kadar geniş bir yelpazede teknoloji çözümleri üreterek,
          geleceğin dijital dünyasına katkıda bulunmak vizyonumuzdur.
        </p>
      </div>
          ...
          {team.map((uye) => (
            <div key={uye.id} className="flex flex-col items-center">
              ...
              <Link href={uye.linkedin} passHref target="_blank">
                <h3 className="text-lg font-semibold underline">{uye.name}</h3>
              </Link>
